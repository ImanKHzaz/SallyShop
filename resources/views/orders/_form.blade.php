<div class="mb-4">
    <label for="user_id" class="form-label fw-bold"><i class="fas fa-user me-2 text-primary"></i>معرف المستخدم (اختياري)</label>
...
<div class="mb-4">
    <label for="cart_id" class="form-label fw-bold"><i class="fas fa-shopping-cart me-2 text-info"></i>معرف السلة (اختياري)</label>
    <input type="number" class="form-control form-control-lg" id="cart_id" name="cart_id"
        value="{{ old('cart_id', $order->cart_id ?? '') }}"
        placeholder="أدخل معرف السلة">
    @error('cart_id')
        <div class="alert alert-danger mt-2"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}</div>
    @enderror
</div>
...
<div class="row">
    <div class="col-md-6 mb-4">
        <label for="total" class="form-label fw-bold"><i class="fas fa-dollar-sign me-2 text-success"></i>الإجمالي (ر.س)</label>
        <input type="number" step="0.01" min="0" class="form-control form-control-lg" id="total" name="total"
...
<div class="mb-4">
    <label for="shipping_address" class="form-label fw-bold"><i class="fas fa-map-marker-alt me-2 text-danger"></i>عنوان الشحن</label>
